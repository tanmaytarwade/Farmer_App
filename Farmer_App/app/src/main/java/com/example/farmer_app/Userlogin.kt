...
import com.example.farmer_app.databinding.ActivityMainBinding
import com.example.farmer_app.databinding.ActivityUserloginBinding
            ...
            auth.signInWithEmailAndPassword(edemail.text.toString(),edpassword.text.toString())
                .addOnCompleteListener {
                    if(it.isSuccessful)
                    {
                        ...
                        val intent = Intent(applicationContext,farmerlocation::class.java)
                        startActivity(intent)
                    }
                    else
                    {
